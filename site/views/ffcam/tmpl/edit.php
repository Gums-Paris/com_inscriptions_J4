...
?>
  ...
  <div style="margin-left: 50px; margin-top: 10px; margin-bottom: 10px;" >
	  <button type="button" onclick="submitbutton('ffcam.save')" 
      class="btn btn-primary btn-lg" id="save">
    Valider
    </button> 
    <button type="button" onclick="submitbutton('ffcam.later')" 
      class="btn btn-success btn-lg" id="suivant" style="margin-left: 20px;">
    Plus tard
    </button>
    <button type="button" onclick="submitbutton('ffcam.suivant')" 
      class="btn btn-warning btn-lg" id="suivant" style="margin-left: 20px;">
    Taguer Sans Modif
    </button>
    <button type="button" onclick="submitbutton('ffcam.cancel')" 
