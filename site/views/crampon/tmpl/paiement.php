...
<span class="liste_titre">Abonnement Crampon - saison <?php echo $this->saison; ?></span>
</div>
...
$field["vads_cust_id"] = 'crampon'.$this->saison;
$field["vads_cust_name"] = str_replace("'", " ", $this->data->name);
$field["vads_cust_email"] = $this->data->email;
$field["vads_url_return"] = "http://".$_SERVER["SERVER_NAME"].JRoute::_('index.php?option=com_inscriptions&amp;view=crampon&amp;layout=aprespaiement', false);
$field["vads_return_mode"] = "GET"; 

$return = JRoute::_('index.php?option=com_inscriptions&view=crampon&task=annuler&controller=crampon', false);
